...
ul.profile-icons li.report-spam-icon	{ width: 16px; height: 16px; }
...
.report-spam-icon, .report-spam-icon a		{ background-image: url("./styles/prosilver/imageset/icon_post_report_spam.gif"); }
